          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 md:p-6 space-y-3">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-2xl md:text-3xl font-bold text-gray-900 font-display mt-0.5">
              ...
              <form onSubmit={handleCreate} className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={type} onValueChange={setType}>
                    <SelectTrigger className="h-12" data-testid="select-medicine-type"><SelectValue /></SelectTrigger>
                    <SelectContent>
                ...
                <Button type="submit" className="w-full h-12 text-base" disabled={createMedicine.isPending} data-testid="button-submit-medicine">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {pendingList.map((med) => {
                    ...
                    return (
                      <div key={med.id} className="flex items-center p-4 rounded-2xl border-2 border-orange-100 bg-white shadow-sm hover:shadow-md transition-all duration-300" data-testid={`card-medicine-${med.id}`}>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            <button onClick={(e) => { e.stopPropagation(); speak(`Time to take ${med.dosage} of ${med.name}`); }} className="p-1 text-gray-400 hover:text-primary transition-colors shrink-0" aria-label="Read aloud" data-testid={`button-speak-${med.id}`}>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {takenList.map((med) => {
                    const Icon = getIcon(med.type);
                    return (
                      <div key={med.id} className="flex items-center p-4 rounded-2xl border border-green-100 bg-green-50 opacity-80 transition-all duration-300" data-testid={`card-medicine-taken-${med.id}`}>
